...
{
    //display an error message if the password is less than 8 characters
    stringOutput = "Password does not meet the requirements. Choose a different password.";
}
//move on to the next requirement test if there are more than 8 characters in the password
else
{
    //use a for loop to compare the user password with the bad passwords in the array
    for (intCount = 0; intCount < arrayBadPasswords.length; intCount++)
    {
        //display an error message when the user password matches an array password
        if (stringPassword === arrayBadPasswords[intCount])
        {
            stringOutput = "Password does not meet the requirements. Choose a different password.";
            //breakout of loop before moving on to else statement
            break;
        }
        else
        {
          //display a good password message when password is longer than 8 characters and does not match a bad password
 ...
 //push the determined output message back to the user through the html   
